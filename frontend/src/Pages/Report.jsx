    ...
    <div className="py-8 px-6 max-w-4xl mx-auto">
      <div className="border-b border-slate-700 pb-6 mb-6">
        ...
        <p className="text-xs text-gray-400 mb-4">
          Confidential — Findings and remediation guidance
        </p>
        <div className="flex flex-wrap items-center gap-3">
          <span
            className={`inline-flex items-center gap-1.5 px-2.5 py-1 rounded border text-xs font-semibold ${severityClass}`}
          >
      ...
      <section className="mb-6">
        ...
        <div className="bg-slate-900/60 border border-slate-700 rounded-lg p-4 text-xs space-y-3">
          ...
          {report.evidence?.proof && (
            <p className="text-gray-500 italic">{report.evidence.proof}</p>
          )}
        </div>
      </section>
